...
## 1. Análisis General de la Serie
...
## 2. Análisis de Promedios Móviles
...
corr_matrix <- cor(datos[, lag_cols], use = "complete.obs")
...
## 4. Descomposición Estacional Aditiva
...
### Implicaciones para Modelado Futuro
